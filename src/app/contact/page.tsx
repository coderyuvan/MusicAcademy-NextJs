    ...
    <div className="min-h-screen bg-black py-12 pt-36 relative">
      ...
      <div className="max-w-2xl mx-auto p-4 relative z-10">
        ...
        <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center">
          Were here to help with any questions about our courses,
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <input
            ...
            className="rounded-lg border border-neutral-800 focus:ring-2  w-full p-4 bg-neutral-950 placeholder:text-neutral-700"
            required
          />
          <textarea
            value={message}
